...
def upgrade() -> None:
    ...
    sa.Column('status', sa.Enum('DISCOVERED', 'WANTED', 'DOWNLOADING', 'DOWNLOADED', 'EXTRACTING', 'EXTRACTED', 'IMPORTING', 'ORGANIZED', 'FAILED', name='designstatus'), nullable=False),
    ...
    sa.Column('source', sa.Enum('AUTO_CAPTION', 'AUTO_FILENAME', 'AUTO_THANGS', 'USER', 'AUTO', 'MANUAL', name='tagsource'), nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=False),
    ...
    sa.Column('id', sa.String(length=36), nullable=False),
    sa.Column('type', sa.Enum('BACKFILL_CHANNEL', 'SYNC_CHANNEL_LIVE', 'DOWNLOAD_DESIGN', 'DOWNLOAD_TELEGRAM_IMAGES', 'EXTRACT_ARCHIVE', 'ANALYZE_3MF', 'GENERATE_RENDER', 'IMPORT_TO_LIBRARY', 'DEDUPE_RECONCILE', 'SYNC_IMPORT_SOURCE', name='jobtype'), nullable=False),
    ...
    sa.Column('design_id', sa.String(length=36), nullable=False),
    sa.Column('source_attachment_id', sa.String(length=36), nullable=True),
    sa.Column('kind', sa.Enum('TELEGRAM_IMAGE', 'THREE_MF_EMBEDDED', 'RENDERED', 'THUMBNAIL', 'FULL', 'GALLERY', name='previewkind'), nullable=False),
